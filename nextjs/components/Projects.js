        ...
        >
          ...
          <div className="col-span-12 md:col-span-5 md:col-start-8 flex items-end">
            <p className="text-base md:text-lg text-bone/70 font-light leading-relaxed">
              Four landscapes, one philosophy — peaceful, monumental,
              future-ready. Each a quiet invitation to belong before the world
              catches up.
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          {projects.map((p, i) => (
            <motion.article
              ...
              className={`group ${p.is_flagship ? "md:col-span-2" : ""}`}
