  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const wa = buildWhatsAppHref(
        `Hello, I'm ${form.name}. I'd like to reserve my place at ${
          form.interest
        }.${form.message ? " " + form.message : ""} My phone: ${form.phone}`
      );
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20">
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-px bg-bone/10 border border-bone/10">
              {TRUST_FACTS.map((f) => (
                <div
                  ...
                  data-testid={`trust-fact-${f.label
                    .toLowerCase()
                    .replace(/\s+/g, "-")}`}
                >
          ...
          <motion.div
            ...
            id="concierge"
          >
            <div className="bg-dune/80 backdrop-blur-md border border-bone/10 p-8 md:p-12 golden-glow animate-glow-pulse">
              ...
              >
                ...
                <div>
                  ...
                  >
                    <option value="Golden Palm City">Golden Palm City</option>
                    <option value="Vantage Farms">Vantage Farms</option>
                    <option value="Chandan Valley">Chandan Valley</option>
                    <option value="Doctor's Colony">Doctor&apos;s Colony</option>
                ...
                <div className="pt-4 flex flex-wrap items-center gap-4">
                  ...
                  >
                    <span>{submitting ? "Reserving..." : "Reserve Your Place"}</span>
