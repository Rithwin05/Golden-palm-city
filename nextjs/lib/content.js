...
export const ACTS = [
  {
    ...
    body: "Beyond the noise of the present, a calmer geography breathes — palm-lined boulevards, monumental architecture, and golden-hour silence shaped for those who arrive first.",
  },
  {
    no: "02",
    label: "Vision",
    title: "A visionary luxury ecosystem.",
    body: "Not a project. A future-city. Designed around peaceful living, eco-futuristic landscaping, and architectural breath — for legacies that outlive trends.",
  },
  {
    no: "03",
    label: "Transformation",
    title: "The future, becoming visible.",
    body: "Infrastructure rises slowly, intentionally. Each boulevard, each water reflection, each villa — composed like cinema. The city does not arrive; it unfolds.",
  },
  {
    no: "04",
    label: "Ownership",
    title: "Belonging, before the world catches up.",
    body: "Imagine evenings under palm shadows, family stories framed by horizon depth, and an asset that quietly appreciates while others rush. This is early ownership of tomorrow.",
  },
];
...
export const STATS = [
  { value: 4, suffix: "+", label: "Premium Projects" },
  { value: 500, suffix: "+", label: "Happy Families" },
  { value: 15, suffix: " yrs", label: "Of Excellence" },
  { value: 1, suffix: " KM", label: "From Highway" },
];

export const ASSETS = {
  hero: "https://customer-assets.emergentagent.com/job_902851f7-4141-441a-b04e-2cfc5affd28f/artifacts/0jqwwqds_Hero%20section.png",
  envBoulevard:
